  ...
  return (
    <Container>
      <Row>
        <Col lg={7}>
          <img
            src={process.env.PUBLIC_URL + "/image/aburia.jpg"}
            width="100%"
            height="90%"
            data-reactied="266"
            style={{
      ...
      <Carousel>
        <Carousel.Item>
          ...
          >
            <Col>
              <img
                src={process.env.PUBLIC_URL + "image2/aburia.jpg"}
                width="300"
                height="250"
                data-reactied="266>"
              />
            ...
            <Col>
              <img
                src={process.env.PUBLIC_URL + "/image2/aburia.png"}
                width="300"
                height="250"
                data-reactied="266>"
              />
